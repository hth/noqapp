    ...
    public static List<StoreHourElastic> getStoreHourElastics(List<StoreHourEntity> storeHours) {
        ...
        for (StoreHourEntity storeHour : storeHours) {
            storeHourElastics.add(new StoreHourElastic()
                ...
                .setAppointmentStartHour(storeHour.getAppointmentStartHour() == 0 ? storeHour.getStartHour() : storeHour.getAppointmentStartHour())
                .setEndHour(storeHour.getEndHour())
                .setAppointmentEndHour(storeHour.getAppointmentEndHour() == 0 ? storeHour.getEndHour() : storeHour.getAppointmentEndHour())
