...
public class JsonProfessionalProfile extends AbstractDomain {
    ...
    public JsonProfessionalProfile setJsonReviewList(JsonReviewList jsonReviewList) {
        this.jsonReviewList = jsonReviewList;
        return this;
    }

    public JsonProfessionalProfile addJsonReview(JsonReview jsonReview) {
        this.jsonReviewList.addJsonReview(jsonReview);
        return this;
    }
