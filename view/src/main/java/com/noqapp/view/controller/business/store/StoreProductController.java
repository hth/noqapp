...
public class StoreProductController {
    ...
    public String add(
        ...
        try {
            StoreProductEntity storeProduct = new StoreProductEntity()
                ...
                .setProductDiscount(StringUtils.isBlank(storeProductForm.getProductDiscount().getText()) ? 0 : new BigDecimal(storeProductForm.getProductDiscount().getText()).multiply(new BigDecimal(100)).intValue())
                ...
                .setAvailableDate(StringUtils.isNotBlank(storeProductForm.getAvailableDate().getText()) ? DateUtil.convertDateStringOf_YYYY_MM_DD_ToDate(storeProductForm.getAvailableDate().getText()) : null)
    ...
    public String editLanding(
        ...
        storeProductForm
            ...
            .setAvailableDate(null != storeProduct.getAvailableDate() ? new ScrubbedInput(DateUtil.dateToString(storeProduct.getAvailableDate())) : null)
