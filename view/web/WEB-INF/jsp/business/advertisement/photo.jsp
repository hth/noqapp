        ...
        <div class="warp-inner">
            ...
            <sec:authorize access="hasAnyRole('ROLE_S_MANAGER')">
                <div class="admin-main">
                    <!-- File Upload From -->
                    <form:form action="${pageContext.request.contextPath}/business/advertisement/upload.htm"
                            modelAttribute="advertisementForm" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="advertisementId" value="${advertisementForm.advertisementId}"/>
                        <div class="admin-title">
                            <h2>Add Advertisement Image</h2>
                        </div>

                        <spring:hasBindErrors name="advertisementForm">
                        <div class="error-box">
                            <div class="error-txt">
                                <ul>
                        ...
                        <div class="admin-content">
                            <div class="add-new">
                                <ul class="list-form">
                                    <li>
                                        <div class="col-lable3" style="padding-top: 30px;">
                                            <form:label path="file" cssErrorClass="lb_error">Select Image</form:label>
                                        </div>
                                ...
                                <div class="col-fields">
                                    <div class="left-btn">
                                        <input name="upload" class="next-btn" value="UPLOAD ADVERTISEMENT IMAGE" type="submit">
                                    </div>
                                    <div class="right-btn">
                    ...
                    <div class="admin-content">
                        <div class="add-new">
                            <c:choose>
                                <c:when test="${!empty advertisementForm.imageUrls}">
                                    <ul class="list-form">
                                        <c:forEach items="${advertisementForm.imageUrls}" var="imageUrl" varStatus="status">
                                        <li>
                                            <div class="col-fields">
                                                <img src="https://s3.ap-south-1.amazonaws.com/${bucketName}/vigyapan/${advertisementForm.advertisementId}/${imageUrl}"
                                                        onerror="this.src='/static2/internal/img/profile-image-192x192.png'"
                                                        class="img-profile-circle" />
                                            </div>
                                            <div class="col-lable3">
                                                <form action="${pageContext.request.contextPath}/business/advertisement/deleteImage.htm" method="post">
                                                    <input type="hidden" name="advertisementId" value="${advertisementForm.advertisementId}"/>
                                ...
                                <c:otherwise>
                                    <div class="alert-info">
                                        <div class="no-approve">Please upload advertisement related image.</div>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </div>
