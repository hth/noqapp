        ...
        <div class="warp-inner">
            ...
            <sec:authorize access="hasAnyRole('ROLE_S_MANAGER')">
                <div class="admin-main">
                    <!-- File Upload From -->
                    <form:form action="${pageContext.request.contextPath}/business/advertisement/upload"
                                    ...
                                    <ul class="list-form">
                                        ...
                                        <li>
                                            ...
                                            <div class="col-lable3">
                                                <form action="${pageContext.request.contextPath}/business/advertisement/deleteImage" method="post">
                                                    <input type="hidden" name="advertisementId" value="${advertisementForm.advertisementId}"/>
