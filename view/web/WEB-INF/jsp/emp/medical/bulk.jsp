<%@ page import="com.noqapp.domain.types.catgeory.HealthCareServiceEnum" %>
...
<div class="main-warp">
        ...
        <div class="warp-inner">
            ...
            <div class="admin-main">
                ...
                <form:form action="${pageContext.request.contextPath}/emp/medical/masterLab/bulk/upload.htm" modelAttribute="masterLabForm" method="post" enctype="multipart/form-data">
                    ...
                    <spring:hasBindErrors name="masterLabForm">
                    <div class="error-box">
                        <div class="error-txt">
                            <ul>
                            ...
                            <ul class="list-form">
                                ...
                                <li>
                                    <div class="col-lable3">
                                        <form:label path="healthCareService" cssErrorClass="lb_error">Health Care Service Type</form:label>
                                    </div>
                                    <div class="col-fields">
                                        <form:select path="healthCareService" cssClass="form-field-select single-dropdown" cssErrorClass="form-field-select single-dropdown error-field" multiple="false">
                                            <form:option value="" label="--- Select ---"/>
                                            <form:options items="${masterLabForm.healthCareServices}" />
                                        </form:select>
                                    </div>
                                </li>
                            </ul>
    ...
    <div class="footer">
        ...
        <div class="footer-dark">
            <div class="footer4">
                <div class="warp-inner">
                    <div class="f-left">&copy; 2020 NoQueue Inc. | <a href="https://noqapp.com/privacy.html">Privacy</a> |
