            ...
            <sec:authorize access="hasAnyRole('ROLE_MEDICAL_TECHNICIAN')">
                <div class="admin-main">
                    <div class="admin-content">
                        <div class="store">
                            <h3>Radiology count: <span>${radiologyForm.radiologies.size()}</span></h3>
                        </div>
                    </div>

                    <c:choose>
                        <c:when test="${!empty radiologyForm.id}">
                            <form:form method="post" action="${pageContext.request.contextPath}/emp/medical/radiology/edit.htm" modelAttribute="radiologyForm">
                                            ...
                                            <li>
                                                ...
                                                <div class="col-fields">
                                                    <form:input path="name" cssClass="form-field-admin" cssErrorClass="form-field-admin error-field"
                                                                placeholder="Name of the Raidology process"/>
                                                </div>
                                                <div class="clearFix"></div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="col-fields">
                                                    <form:input path="category" cssClass="form-field-admin" cssErrorClass="form-field-admin error-field"
                                                                placeholder="Specify category if any"/>
                                                </div>
                                                <div class="clearFix"></div>
                                            </li>
                                        </ul>
                        ...
                        <c:otherwise>
                            <form:form method="post" action="${pageContext.request.contextPath}/emp/medical/radiology/add.htm" modelAttribute="radiologyForm">
                                <spring:hasBindErrors name="radiologyForm">
                                <div class="error-box">
                                    <div class="error-txt">
                                        <ul>
                    ...
                    <c:if test="${!empty radiologyForm.radiologies}">
                        <div class="alert-info">
                            All supported radiology test are listed below.
                        </div>
                        <h2>Total Radiologies: <span>${radiologyForm.radiologies.size()}</span></h2>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <c:forEach items="${radiologyForm.radiologies}" var="radiology" varStatus="status">
                                <tr>
                                    <td>${status.count}&nbsp;</td>
                                    <td nowrap>${radiology.name}</td>
                                    <td nowrap>${radiology.category}</td>
                                    <td nowrap>
                                        <a href="/emp/medical/radiology/${radiology.id}/edit.htm" class="add-btn">Edit</a>
                                    </td>
                                    <td nowrap>
                                        <form:form method="post" action="${pageContext.request.contextPath}/emp/medical/radiology/delete.htm" modelAttribute="radiologyForm">
                                            <form:hidden path="id" value="${radiology.id}" />
