            ...
            <div class="login-box">
                <div class="form-style">
                    <form id="sign-in-form" action="">
                        ...
                        <c:if test="${!empty param.joinFailure and param.joinFailure eq 'p--'}">
                        <div class="error-box">
                    ...
                    <div class="otp">
                        ...
                        <form:form id="webJoinQueue" method="post" modelAttribute="webJoinQueue">
    ...
    <div class="footer">
        ...
        <div class="footer-dark">
            <div class="footer4">
                <div class="warp-inner">
                    <div class="f-left">
                        &copy; 2019 NoQueue Inc. | <a href="https://noqapp.com/privacy.html">Privacy</a> | <a href="https://noqapp.com/terms.html">Terms</a><br/>
...
//                alert('Pass 1');
                ...
                noQAuthentication.doJoinQueue(user);
                //displayinfo(user);
            }).catch(function (error) {
                //alert('fail');
                window.verifyingCode = false;
