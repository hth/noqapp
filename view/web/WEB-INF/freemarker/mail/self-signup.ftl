...
<div class="email-style"
    ...
    <div class="qr-footer" style="font-size:12px; background:#dadada; padding:15px;">
        ...
        All Rights Reserved &nbsp; | &nbsp; <a href="${parentHost}/#/pages/privacy" style="color:#222; text-decoration:none">Privacy Policy</a> &nbsp; |&nbsp; <a href="${parentHost}/terms.html" style="color:#222; text-decoration:none">Terms</a><br/>
