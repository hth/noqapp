                ...
                <div class="down_form" style="width: 90%">
                    <form:form commandName="inviteQueueSupervisor">
                        ...
                        <div class="row_field">
                            ...
                            <form:input path="countryShortName" size="20" cssClass="name_txt" readonly="true" />
                        </div>
                        <div class="row_field">
                            ...
                            <form:input path="countryCode" size="20" cssClass="name_txt" readonly="true" />
                        </div>
                        <div class="row_field">
                            ...
                            <form:input path="phoneNumber" size="20" cssClass="name_txt" readonly="true" />
                        ...
                        <div class="row_field">
                            ...
                            <form:input path="inviteeCode" size="20" cssClass="name_txt" readonly="true" />
