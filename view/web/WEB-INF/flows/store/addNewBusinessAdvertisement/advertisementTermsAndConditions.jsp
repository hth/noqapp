                        ...
                        <div class="admin-title">
                            <c:choose>
                                <c:when test="${!empty advertisementForm.advertisementId}">
                                    <h2>Edit Advertisement Terms & Conditions</h2>
                                </c:when>
                                <c:otherwise>
                                    <h2>Add Advertisement Terms & Conditions</h2>
                                </c:otherwise>
                            </c:choose>
                        </div>
                        <div class="error-box">
                            ...
                            <div class="add-new">
                                ...
                                <div class="col-fields">
                                    <div class="button-btn">
                                        <button name="_eventId_add_terms_and_conditions" class="ladda-button next-btn" style="width:48%; float: left">Add T&C</button>
                                        <button name="_eventId_remove_all_terms_and_conditions" class="ladda-button next-btn" style="width:48%; float: right">Reset T&C</button>
                                    </div>
                                    <div class="clearFix"></div>
                                </div>
                                <div class="clearFix"></div>
