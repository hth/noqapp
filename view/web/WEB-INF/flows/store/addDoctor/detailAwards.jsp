            ...
            <div class="admin-main">
                ...
                <form:form modelAttribute="professionalProfileEditForm">
                    ...
                    <div class="admin-content">
                        <div class="add-new">
                            <ul class="list-form">
                                <form:hidden path="action" value="awards" />
                                <li>
                                ...
                                <div class="col-fields">
                                    ...
                                    <div class="center-btn">
                                        <button name="_eventId_reset" class="ladda-button cancel-btn" style="width:100%;"> RESET AWARDS</button>
                                    </div>
                                    <div class="last-btn">
                                ...
                                <fieldset>
                                    <div class="store-table">
                                        <c:choose>
                                            <c:when test="${!empty professionalProfile.awards}">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <c:forEach items="${professionalProfile.awards}" var="nameDatePair" varStatus="status">
                                                    <tr>
                                                        <td>${status.count}&nbsp;</td>
