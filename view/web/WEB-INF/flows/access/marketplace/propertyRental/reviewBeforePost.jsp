    ...
    <div class="content">
        <div class="warp-inner">
            ...
            <div class="admin-main">
                <form:form modelAttribute="postOnMarketplaceForm">
                    ...
                    <div class="admin-content">
                        <div class="add-new">
                            <ul class="list-form">
                                <ul class="list-form">
                                    ...
                                    <li>
                                        ...
                                        <div class="col-fields">
                                            <c:out value="${postOnMarketplaceForm.marketplace.description}" escapeXml="false"/>
                                        </div>
                                        <span class="tooltip" title="Primary business type. This <b><u>cannot</u></b> be changed later." style="padding-left: 10px;"><i class="fas fa-info-circle"></i></span>
                                        <sup style="color: #9f1313; font-size: 150%;">*</sup>
                                        <div class="clearFix"></div>
                                ...
                                <c:choose>
                                    <c:when test="${postOnMarketplaceForm.businessType eq BusinessTypeEnum.PR}">
                                        <li>
                                            <div class="col-lable3">
                                        ...
                                        <li>
                                            ...
                                            <div class="col-fields">
                                                <form:select path="marketplace.rentalType" cssClass="form-field-select single-dropdown" cssErrorClass="form-field-select single-dropdown error-field" multiple="false">
                                                    <form:options items="${postOnMarketplaceForm.rentalTypes}" itemValue="name" itemLabel="description" disabled="true"/>
                                                </form:select>
                                            </div>
                                            <span class="tooltip" title="Primary business type. This <b><u>cannot</u></b> be changed later." style="padding-left: 10px;"><i class="fas fa-info-circle"></i></span>
                                            <sup style="color: #9f1313; font-size: 150%;">*</sup>
                            ...
                            <div class="col-fields">
                                <c:choose>
                                    <c:when test="${postOnMarketplaceForm.validateByQid}">
...
<script>
    CKEDITOR.replace('postOnMarketplaceForm.marketplace.description');
</script>
