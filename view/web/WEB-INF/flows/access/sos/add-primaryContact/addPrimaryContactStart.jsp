            ...
            <div class="admin-main">
                <sec:authorize access="hasAnyRole('ROLE_CLIENT')">
                    ...
                    <div class="admin-title">
                        <h2>Add New Primary Contact</h2>
                    </div>

                    <form:form modelAttribute="addPrimaryContactMessageSOSForm">
                        <input type="hidden" name="_flowExecutionKey" value="${flowExecutionKey}"/>
                        <input type="hidden" id="countryShortName" name="countryShortName" value="${addPrimaryContactMessageSOSForm.countryShortName}"/>
...
<script>
    ...
    $("#phoneNumber").on("countrychange", function(e, countryData) {
        $("#countryShortName").val(countryData.iso2.toUpperCase())
    });
</script>
