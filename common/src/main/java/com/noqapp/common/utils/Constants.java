...
public class Constants {
    ...
    public static final String MAX_Q_SEARCH_DISTANCE = "2000"; //Close to 93 Miles or 150 KM
    ...
    public static final String WORD_PATTERN_TEXT = " words 'A-to-Z', spaces ' ' and/or dots '.'";
